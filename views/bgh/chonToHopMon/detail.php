...
<div class="container mt-4">
    ...
    <div class="mb-4">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="/modules/chonToHopMon/quanLyChonList.php">Danh Sách Tổ Hợp Môn</a></li>
    ...
    <!-- Back Button -->
    <div class="mt-4">
        <a href="/modules/chonToHopMon/quanLyChonList.php" class="btn btn-outline-secondary">
