    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="/public/index.php?action=bgh-quan-ly-giao-vien" class="btn btn-outline-secondary">
            ...
            <div class="card card-assignment">
                <div class="card-body">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="/public/index.php?action=bgh-quan-ly-giao-vien&sub_action=create">
                                <!-- Mã trường & Năm vào -->
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="soCCCD" class="form-control" 
                                           value="<?php echo htmlspecialchars($data['soCCCD'] ?? ''); ?>" 
                                           placeholder="VD: 079000000001" 
                                           pattern="[0-9]{12}" 
                                           maxlength="12"
                                           required>
                                    <small class="text-muted">
                                        <i class="fa-solid fa-info-circle me-1"></i>
                                        12 chữ số (ví dụ: 079000000001)
                                    </small>
                                </div>
                                ...
                                <div class="d-flex justify-content-end gap-2 mt-4">
                                    <a href="/public/index.php?action=bgh-quan-ly-giao-vien" class="btn btn-secondary">
